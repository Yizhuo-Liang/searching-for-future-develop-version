...
function draw() {
	...
	object.draw();
	if (object.mouseIsHovered()) {
		textSize(32);
		fill(200);
		textAlign(LEFT, TOP);
		text("This circle represents something or other", object.x, object.y + object.radius);
	}
}
