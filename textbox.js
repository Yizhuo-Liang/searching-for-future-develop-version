...
function setup() {
	...
	_W = windowWidth;
	_H = windowHeight;
	s = '"' + "Of course machines can't think as people do. A machine is different from a person. Hence, they think differently. The interesting question is, just because something, uh.. thinks differently from you, does that mean it's not thinking?" + '"'
	s2 = "- Alan Turing in \n'The Imitation Game'"
}
